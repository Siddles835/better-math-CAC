  ...
  return (
    <SiteChrome>
      ...
      <p className="text-[15px] leading-relaxed text-muted-foreground mb-8">
        ...
        class; students join with a generated space name. After practice, the teacher dashboard
        shows a thinking summary and a short briefing. Drawings stay on the device.
      </p>
      ...
      <section className="mb-8 rounded-2xl border border-border bg-card/90 p-6">
        ...
        <ul className="space-y-3 text-[15px] text-muted-foreground list-disc pl-5">
          ...
          <li>
            ...
            {' '}or preview the{' '}
            <Link to="/classroom" className="underline hover:text-foreground">
              sample classroom
            </Link>
            .
          </li>
      ...
      <section className="rounded-2xl border border-border bg-card/90 p-6">
        ...
        <p className="text-[15px] leading-relaxed text-muted-foreground">
          ...
          , and{' '}
          <Link to="/methods" className="text-primary hover:underline font-medium">
            how the models work
          </Link>
          .
        </p>
